...
Label4 = Label(fenetre, text = 'Number of Blocks :')
Label4.pack()
...
Label6 = Label(fenetre, text = 'Length in bits of a block :')
Label6.pack()
...
bouton1.pack()
bouton1.place(x=250,y=130)
bouton2.pack()
bouton2.place(x=250,y=160)
bouton3.pack()
bouton3.place(x=250,y=190)
